...
/*
   Dit is één klasse uit het JUnit framework, vandaar de vele foutmeldingen.
   Het gaat hier om de Javadoc, ook hier zullen er warnings en errors opduiken.
   gezien de verwijzingen naar andere klassen!

   De bedoeling is te tonen hoe professionele Java programmeurs hun code documenteren.
 */
