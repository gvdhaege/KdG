...
/**
 * Basisklasse Gebruiker
 * Merk op dat het attribuut sleutel de PK bevat en dat de uniciteit afhangt van dit attribuut.
 * Vandaar de override van equals en hashCode
 */
public class Gebruiker {
    private int sleutel; //PK
