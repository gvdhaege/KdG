 ...
 */
public class DemoWriteGeenAnnotatiesMuseums {
    private static final String file = "museumsGeenAnnotaties.xml";
    ...
    public static void main(String[] args) {
        try {
            ...
            jaxbMarshaller.marshal(museums, new File(file));
