...
public class WielRenner implements Comparable<be.kdg.wielrennen.model.WielRenner> {
    ...
    public boolean equals(Object o) {
        ...
        be.kdg.wielrennen.model.WielRenner that = (be.kdg.wielrennen.model.WielRenner) o;
    ...
    @Override
    public int compareTo(be.kdg.wielrennen.model.WielRenner o) {
        return Comparator.comparing(be.kdg.wielrennen.model.WielRenner::getNaam)
                .thenComparing(be.kdg.wielrennen.model.WielRenner::getVoornaam)
                .compare(this, o);
    }
