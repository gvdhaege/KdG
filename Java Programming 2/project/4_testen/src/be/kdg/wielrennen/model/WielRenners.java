...
public class WielRenners {
    private static final Logger logger = Logger.getLogger("be.kdg.wielrennen.model.WielRenners");
    ...
    public boolean voegToe(WielRenner wielRenner) {
        logger.log(Level.FINER, "Wielrenner {0} {1} is toegevoegd aan de lijst", new Object[]{wielRenner.getNaam(), wielRenner.getVoornaam()});
    ...
    public boolean verwijder(String naam, String voornaam) {
        for (WielRenner wielRenner : wielRenners) {
            if (naam.equalsIgnoreCase(wielRenner.getNaam()) && voornaam.equals(wielRenner.getVoornaam())) {
                logger.log(Level.FINER, "Wielrenner {0} {1} is verwijderd uit de lijst", new Object[]{wielRenner.getNaam(), wielRenner.getVoornaam()});
